...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/adminp/src/assets')}}/images/favicon.png">
    <title>Adminmart Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="{{asset('assets/adminp/src/assets')}}/libs/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{asset('assets/adminp/src')}}/dist/css/style.min.css" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{asset('assets/adminp/src/assets')}}/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="{{asset('assets/adminp/src/assets')}}/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('assets/adminp/src/assets')}}/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="{{asset('assets/adminp/src/assets')}}/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{asset('assets/adminp/src/assets')}}/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{asset('assets/adminp/src')}}../docs/docs.html"
                                                ...
                                                <div class="col-md-12">
                                                    <div id="calendar-events" class="">
                                                        <div class="calendar-events mb-3" data-class="bg-info"><i
                                                                class="fa fa-circle text-info mr-2"></i>Ali Mert</div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('assets/adminp/src/assets')}}/libs/jquery/dist/jquery.min.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/extra-libs/taskboard/js/jquery.ui.touch-punch-improved.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/extra-libs/taskboard/js/jquery-ui.min.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <script src="{{asset('assets/adminp/src')}}/dist/js/app-style-switcher.js"></script>
    <script src="{{asset('assets/adminp/src')}}/dist/js/feather.min.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="{{asset('assets/adminp/src')}}/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('assets/adminp/src')}}/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="{{asset('assets/adminp/src/assets')}}/libs/moment/min/moment.min.js"></script>
    <script src="{{asset('assets/adminp/src/assets')}}/libs/fullcalendar/dist/fullcalendar.min.js"></script>
    <script src="{{asset('assets/adminp/src')}}/dist/js/pages/calendar/cal-init.js"></script>
</body>
